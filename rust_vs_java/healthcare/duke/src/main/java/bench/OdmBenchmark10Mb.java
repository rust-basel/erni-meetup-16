...
public class OdmBenchmark10Mb {
    ...
    public void setup() throws IOException {
        ...
        try (var stream = getClass().getClassLoader().getResourceAsStream("test_10mb.xml")) {
            if (stream == null) {
                throw new IllegalStateException("test_10mb.xml not found on classpath");
            }
